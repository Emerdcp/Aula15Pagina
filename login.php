            ...
            <form action="login-validar.php" method="post">
                <div class="row">
                    ...
                    <hr>
                        ...
                        <input type="email" id="usuario" class="form-control" placeholder="E-mail" name="usuario" required>
                    </div>
                </div>
                <div class="row">
                    <div class="col text-center mt-3">
                    ...
                    <div class="col text-center mt-3">
                        <button type="submit" class="btn btn-dark ms-2"><i class="bi bi-save"></i>Entrar</button>
                    </div>
                    <hr>
                </div>
            </form>
